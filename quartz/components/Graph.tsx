...
export default ((opts?: Partial<GraphOptions>) => {
  const Graph: QuartzComponent = ({ displayClass, cfg }: QuartzComponentProps) => {
    ...
    const [localGraphCfg, setLocalGraphCfg] = useState<string>(
    ...
    return (
      <div class={classNames(displayClass, "graph")}>
        ...
        <div class="graph-outer">
          <div class="graph-container" data-cfg={localGraphCfg}></div>
        ...
        <div class="global-graph-outer">
          <div class="global-graph-container" data-cfg={JSON.stringify({ ...defaultOptions.globalGraph, ...opts?.globalGraph })}></div>
        </div>
      </div>
    );
  };
